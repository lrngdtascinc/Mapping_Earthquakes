...
// D-2 step1. Add a 3rd layer group for the major earthquake data.
...
let map = L.map('mapid', {
    center: [30, 30],
    zoom: 2,
    layers: [dark, earthquakes, tectonicplates, majorEarthquakes]
})
